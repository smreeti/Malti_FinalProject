...
const dashboard = (req, res) => {
  let booksQuery = `SELECT b.name as bookName, CONCAT(a.firstName, ' ', a.lastName) as authorName, bc.categoryName, b.price, b.ISBN, b.image
                        FROM book AS b
                        JOIN author AS a
  ...
  let stockQuery = `SELECT b.name as bookName, CONCAT(a.firstName, ' ', a.lastName) as authorName, bc.categoryName, b.price, b.ISBN, s.quantity, b.image
                        FROM book AS b
                        JOIN bookstock AS s
